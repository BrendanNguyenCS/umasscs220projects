...
The statement, ``This statement is false," is not a proposition because it cannot have a truth value. If the statement was true, then it would assert that it's false, which is a contradiction. Similarly, if the statement was false, it would assert that it's true, another contradiction.
